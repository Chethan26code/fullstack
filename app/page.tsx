        ...
        <div className="flex flex-col gap-6 md:gap-8">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-semibold text-white mb-3">
              Authentication boilerplate for your Next.js app
            </h1>
            <p className="text-sm md:text-base text-slate-400 max-w-xl">
              Sign up with email/password or Google, built with Next.js App
              Router, TypeScript, Tailwind CSS, and Firebase Authentication.
            </p>
          </div>
          ...
          <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-slate-400">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-3">
              <p className="font-medium text-slate-200 mb-1">Tech stack</p>
              <p>Next.js · TypeScript · Tailwind CSS</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-3">
              <p className="font-medium text-slate-200 mb-1">Auth methods</p>
              <p>Email &amp; password · Google OAuth</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-3">
              <p className="font-medium text-slate-200 mb-1">Firebase</p>
              <p>Using Firebase Authentication SDK</p>
            </div>
          </div>
        </div>
      </div>
